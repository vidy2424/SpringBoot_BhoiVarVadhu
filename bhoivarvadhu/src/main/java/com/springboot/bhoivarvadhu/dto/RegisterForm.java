...
public class RegisterForm {
	...
	// default constructor
		...
		public String toString() {
			return "RegisterForm [id=" + id + ", fullName=" + fullName + ", dOB=" + dOB + ", marital_Status="
					+ marital_Status + ", caste=" + caste + ", your_Surname=" + your_Surname
					...
					+ job_business + ", annual_Income=" + annual_Income + ", father=" + father + ", education="
					+ education + ", occupation=" + occupation + ", groom_Bride=" + groom_Bride + ", mother=" + mother
					+ ", brother=" + brother + ", sister=" + sister + ", married_Brother=" + married_Brother
					+ ", married_Sister=" + married_Sister + ", email=" + email + ", password=" + password
					+ ", permanent_Address=" + permanent_Address + ", current_Address=" + current_Address + ", city="
					+ city + ", contact_No_1=" + contact_No_1 + ", contact_No_2=" + contact_No_2 + ", landline_No="
					+ landline_No + ", zodiac_Sign=" + zodiac_Sign + ", mangal=" + mangal + ", nakshatras=" + nakshatras
					+ ", birth_Time=" + birth_Time + ", birth_Time_HrMin=" + birth_Time_HrMin + ", birth_Place="
					+ birth_Place + ", nadi=" + nadi + ", height=" + height + ", weight=" + weight + ", blood_Group="
					+ blood_Group + ", complexion=" + complexion + ", physical_Disability=" + physical_Disability
					+ ", mention_Physical_Disability=" + mention_Physical_Disability + ", education_Expectation="
					+ education_Expectation + ", job_Expectation=" + job_Expectation + ", annual_Income_Expectation="
					+ annual_Income_Expectation + ", age_Difference_Expectation=" + age_Difference_Expectation
					+ ", city_Priority_Expectation=" + city_Priority_Expectation + ", other_Expectation="
					+ other_Expectation + ", code=" + code + ", file=" + file + "]";
		}
